...
export function ScoreTooltip({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      {children}
      {show && (
        <span className="absolute left-1/2 top-full z-50 mt-2 w-56 max-w-[calc(100vw-2rem)] -translate-x-1/2 rounded-lg bg-neutral-900 px-3 py-2 text-center text-xs font-normal normal-case tracking-normal text-white shadow-lg">
